...
const TabelInfo = ({ data, page, refresher }) => {
  ...
  return (
    <>
              ...
              >
                <Table.Cell>
                  <div className="flex flex-col items-start gap-2">
                    <p className=" table-badge">1/{ele.gambar.length}</p>
                    <img
                ...
                <Table.Cell>{ele.headline}</Table.Cell>
      ...
      <DeleteModal
        ...
        namaItem={judulItem}
        deleteFunction={`${base_url}/infografik/delete/${idItem}`}
        refresher={refresher}
      />
      {/* open modal */}
    </>
