...
const TableList = ({ data, page, refresher }) => {
  ...
  return (
    <>
              ...
              >
                ...
                <Table.Cell className="whitespace-nowrap font-medium text-gray-900 dark:text-white line-clamp-3 truncate max-w-72">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="truncate">{ele.judul || ele.judul_video}</p>
                  </div>
                </Table.Cell>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                     aria-label="table-delete-button"
                      onClick={() =>
                        handleModal(ele._id || ele.id, ele.judul_video)
                      }
                    >
                      <HiOutlineTrash />
                    </button>
      ...
      <DeleteModal
        ...
        namaItem={judulItem}
        deleteFunction={`${base_url}/videokajian/delete/${idItem}`}
        refresher={refresher}
      />
      {/* open modal */}

      {/* <Toaster showtoast={showToast} /> */}
    </>
  );
};
